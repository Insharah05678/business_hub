...
import 'package:untitled6/Screens/ProfileCardI.dart';
          ...
          children: [
            ...
            Container(
              child: ElevatedButton(
                child: Text('Scrafs',),
                onPressed: () {Navigator.push(context as BuildContext, MaterialPageRoute(builder: (BuildContext) => ProfileCardI()/*ProfileCardI()*/),);},),),
            SizedBox(height: 10),
            /*Container(
              child: ElevatedButton(
                child: Text('Dresses',),
                onPressed: () {Navigator.push(context as BuildContext, MaterialPageRoute(builder: (BuildContext) => Products()/*ProfileCardII()*/),);},),),
            //SizedBox(height: 50),*/
